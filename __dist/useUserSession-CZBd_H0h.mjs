import { d as Qe, y as Ze } from "./compat.module-BTlffX0d.mjs";
import { a as Ye } from "./appUrls-D5W3wIqB.mjs";
function xe(e, t) {
  return function() {
...
const rt = X("string"), A = X("function"), Pe = X("number"), G = (e) => e !== null && typeof e == "object", st = (e) => e === !0 || e === !1, $ = (e) => {
  if (K(e) !== "object")
    return !1;
  const t = le(e);
...
const U = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : global, Fe = (e) => !q(e) && e !== U;
function re() {
  ...
  function u(p, y, h) {
    ...
    if (p && !h && typeof p == "object") {
      if (a.endsWith(y, "{}"))
        ...
        return y = ke(y), w.forEach(function(g, P) {
...
const Je = (e) => {
...
}, Z = typeof fetch == "function" && typeof Request == "function" && typeof Response == "function", Ve = Z && typeof ReadableStream == "function", Sn = Z && (typeof TextEncoder == "function" ? /* @__PURE__ */ ((e) => (t) => e.encode(t))(new TextEncoder()) : async (e) => new Uint8Array(await new Response(e).arrayBuffer())), We = (e, ...t) => {
  try {
    return !!e(...t);
  } catch {
    return !1;
  ...
  return e && !t;
}), ge = 64 * 1024, ie = Ve && We(() => a.isReadableStream(new Response("").body)), W = {
  stream: ie && ((e) => e.body)
};
Z && ((e) => {
...
const On = async (e) => {
  ...
  try {
    ...
    if (ie && (c || g && y)) {
      ...
      const _ = a.toFiniteNumber(S.headers.get("content-length")), [F, M] = c && we(
        _,
        V(Ee(c), !0)
      ) || [];
      S = new Response(
...
const {
  ...
  const [e, t] = Qe(null);
  return Ze(() => {
    E.get(`${Ye.getBase({ environment: process.env.NODE_ENV || void 0 })}/sso/session`, { withCredentials: !0 }).then((r) => {
      t(r.data.user);
    });
  }, []), { user: e, logout: () => {
